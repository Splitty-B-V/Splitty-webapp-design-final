    ...
    <div className="min-h-screen bg-gray-100">
      <div className="min-h-screen max-w-[500px] mx-auto bg-gray-50 shadow-lg">
        ...
        <div className="text-center mb-4 sm:mb-6 pt-6 sm:pt-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">Rekening volledig betaald</h1>
          <p className="text-gray-600 text-sm sm:text-base">Restaurant Limon - Tafel 1</p>
        </div>
          ...
          <div className="space-y-2 sm:space-y-3">
            {payments.map((payment, index) => (
              <div key={payment.id} className="flex justify-between items-center">
                <span className="text-gray-600 text-xs sm:text-sm">Betaling {index + 1}</span>
        ...
        <div className="text-center mt-6 sm:mt-8">
          <p className="text-gray-500 text-xs sm:text-sm">
            Bedankt voor het gebruiken van Splitty! 
          </p>
