    ...
    <div className="flex flex-col h-full" style={{ maxHeight: 'calc(95vh - 100px)' }}>
      ...
      <div className="flex-shrink-0 pt-6 pb-4 px-4">
        <div className="flex items-center justify-between mb-4">
          ...
          <h2 className="text-xl font-bold text-black">Betaal voor personen</h2>
        ...
        <div className="bg-gray-50 rounded-2xl p-6">
          ...
          <div className="flex items-center justify-center gap-6 mb-8">
            ...
            <div className="bg-white rounded-2xl px-8 py-4 shadow-lg">
              <span className="text-5xl font-bold text-black">{selectedPeople}</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white rounded-xl p-4">
                <p className="text-xs text-gray-600 mb-1">Per persoon</p>
                <p className="text-lg font-semibold text-black">€{perPersonAmount.toFixed(2).replace('.', ',')}</p>
              </div>
              <div className="bg-white rounded-xl p-4">
                <p className="text-xs text-gray-600 mb-1">Totaal</p>
                <p className="text-lg font-semibold text-black">€{total.toFixed(2).replace('.', ',')}</p>
              </div>
            </div>
